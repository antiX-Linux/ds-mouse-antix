...
class mainWindow(Gtk.Window):
    ...
    def startup_write(self, FROM, TO):
        ...
        for line in open(Var.CONF_USER_STARTUP, "r").xreadlines():
    ...
    def __init__(self):
        ...
        store.append([0, "Right hand layout"])
        store.append([1, "Left hand layout"])
        ...
        self.framebox.pack_start(theme, False, False, 0)
        theme.show()
        ...
        self.startup.set_size_request(0,40)
        self.framebox.pack_start(self.startup, False, False, 0)
        if Var.startstatus :
            self.startup.set_active(True)
        else:
            self.startup.set_active(False)        
